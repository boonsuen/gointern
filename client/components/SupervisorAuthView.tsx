...
export const SupervisorAuthView = ({
  setUser,
}: {
  ...
  const onLoginFormFinish = async (values: LoginValues) => {
    try {
      const response = await (
        await fetch(`${API_URL}/supervisors/login`, {
          method: 'POST',
          headers: {
  ...
  const onSignUpFormFinish = async (values: SignUpValues) => {
    try {
      const response = await (
        await fetch(`${API_URL}/supervisors/signup`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
          ...
          >
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: 'Please enter supervisor email',
                },
              ]}
            >
